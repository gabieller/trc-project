...
import ShowMedium from "../components/ShowMedium"
...
export class Blog extends Component {
  ...
  mediumURL =
    "https://api.rss2json.com/v1/api.json?rss_url=https://medium.com/feed/@routable-ai"
  ...
  render() {
    ...
    if (this.state.item) {
      post = this.state.item.map((post, index) => (
        <ShowMedium key={index} {...post} {...this.state.profile} {...index} />
      ))
    }
