      ...
      <div id="solutions-page" className="container-fluid">
        <div className="section title justify-content-left pl-md-5 pl-xs-0">
          <div className="row container solutions-header-title pl-5 mx-3">
            <div className="col-md-7 col-xs-8 pt-5">
          ...
          <div className="row container py-3 pl-5">
            ...
            <div className="card col-lg-3 flex-md-column border border-dark py-4 px-4 mb-3 mx-3">
              <div className="card-body p-0">
                <h4 className="card-title col-md-10 px-0 text-left font-weight-bold pt-2">
            ...
            <div className="card col-lg-3 flex-md-column border border-dark py-4 px-4 mb-3 mx-3">
              <div className="card-body p-0">
                <h4 className="card-title col-md-11 px-0 text-left font-weight-bold">
              ...
              <div id="solutions-how-it-works">
                <div className="row p-0">
                  <div className="col-sm-7 border border-dark border-right-0 title">
                    ...
                    <p className="col-md-10 p-0 p-sm-2 pl-0">
                ...
                <div className="row">
                  ...
                  <div className="col-sm-5 border-left border-bottom border-dark pt-5 col-left">
                    <div className="row container py-5 col-md-9">
                      <h3 className="pb-3 font-weight-bold">1. We partner with you</h3>
                      We work with you to build solutions that are tailor-made
                      to your transit needs.
                    </div>
                    <div className="row container ">
                      <div className="row container py-5 col-md-9">
                        <h3 className="pb-3 font-weight-bold">
                ...
                <div className="row border-bottom border-dark pt-5">
                  <div className="row container">
                    <div className="row container py-3 px-4">
                      <h3 className="pb-2">1. We partner with you</h3>
                      We work with you to build solutions that are tailor-made
                      to your transit needs.
                    </div>
                  </div>
        ...
        <div id="pingo-solutions">
          <div className="row container py-5 px-5">
            <div className="row border border-dark bg-white">
              <div className="col-sm-5 col-xs-3 px-0">
                <img
                  src={pingosolutions}
                  alt="Pingo Solutions"
                  width="100%"
              ...
              <div className="col-sm-7 col-xs-8 py-md-5 py-xs-0">
