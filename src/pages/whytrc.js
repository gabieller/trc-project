  ...
  return (
    <Layout {...props}>
      <div id="solutions-page" className="container-fluid">
        <div className="section why-trc">
          <div className="container g-0">
            <div className="row pb-5">
              <h1>It’s time</h1>
              <h1>to launch the most efficient</h1>
              <h1>on-demand transportation system in the world</h1>
            </div>
            <div className="row">
        ...
        <div className="section  why-trc pb-0">
            ...
            <div className="row">
              <div className="col-md-7 how-it-works">
                ...
                <div className="col-9">
                  ...
                  technology. It’s the first set of tools in microtransit to
                  allow you to match 14+ riders in a vehicle safely at once.
                </div>
              </div>
          ...
          <div className=" container box-shadow shadow ">
            <div className="d-flex flex-row align-items-center justify-content-center">
              ...
              <div className="col-7 px-5">
                ...
                <h2 className="fw-bold">Download our rider app</h2>
