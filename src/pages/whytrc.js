    ...
    <Layout {...props}>
      <div id="whytrc">
        <div className="container-fluid">
          ...
          <div className="container px-5 text-margin">
            <div className="row row-cols-1 row-cols-md-4 cards-row">
              ...
              <div className="col-md-3 pb-3 pb-md-0 ps-md-0 pe-md-3">
                <div
                  ...
                  onClick={() =>
                    changeText(
                      "Cost per rider trip is on-par with fixed routes"
                    )
                  }
                >
                  <div className="card-body h-75 icons d-flex flex-row ps-md-1 ps-lg-3">
          ...
          <div className="why-trc text-margin px-md-5 mx-md-3 px-3">
            <div className="container px-5">
              <div className="row">
                ...
                <div className="col-md-3 text-center pb-2">
                  Global optimization allows you to optimize for the city not
                  the individual
                </div>
                <div className="col-md-1 text-center pb-2">
                  <img src={add_circle} alt="Add Icon" />
                ...
                <div className="d-flex justify-content-center text-margin">
                  <hr className="col-9 line-middle" />
                </div>
              </div>
              <div className="d-flex flex-column d-flex justify-content-center  equal-icon">
                <div className="d-flex justify-content-center">
                  <img src={equal_circle} alt="Equal Icon" />
                </div>
              </div>
              <div>
                <h2 className="text-center text-margin fw-bold">
                  {buttonText}
                </h2>
              </div>
            </div>
          ...
          <div className="row col-9 justify-content-center text-margin">
        ...
        <div className="container-fluid  border border-dark bg-white">
          <div className="row">
            <div className="col-12 col-md-7 how-it-works d-flex flex-column justify-content-center align-items-center px-5 text-margin">
