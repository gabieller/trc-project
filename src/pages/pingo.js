        ...
        <div>
          {isDesktopOrLaptop && (
            <>
                ...
                <div className="row container justify-content-center">
                  ...
                  <div className="col-md-6 py-5">
                    ...
                    <div className="about-text py-4">
                      ...
                      ponderum. Est audiam animal molestiae te. Ex duo eripuit
                      mentitum.
                    </div>
                  </div>
                </div>
              ...
              <div id="pingo-trc">
                <div className="row container border border-dark py-5">
                  <div className="col-sm-6 text-center">
                    <img src={mockup} alt="Mockup" width="100%" height="100%" />
                  </div>
                  <div className="col-sm-6 py-5">
                    <div className="row container col-sm-9">
          ...
          {isTabletOrMobileDevice && (
            <>
              <div id="pingo-header">
                <div className="row container justify-content-center pingo-landing-page">
                  <img
                    ...
                    height="400"
                  />
                  <h3 className="mobile-subtitle pt-5 pl-3">
              ...
              <div id="about-mobile">
                <div className="text-center pt-3 mockup-mobile">
                  <img
                    src={pingo_mockup}
                    alt="Mockup Mobile"
                    width="125%"
                ...
                <div className="row container col-8 justify-content-left py-3">
                  <h4>About the product offered, areaea usu, quipscing te.</h4>
                  Et has minim elitr intellegat. Mea aeterno eleifend antiopam
                  ad, nam no suscipit quaerendum. At nam minimum ponderum. Est
